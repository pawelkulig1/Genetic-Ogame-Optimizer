...
void test_my_queue23()
{
	std::vector<int> in = {6,0,0,6,1,1,6,1,0,6,0,0,6,0,0,6,2,0,6,0,6,3,0,3,9,3,1,6,0,0,6,3,4,0,1,3,9,3,1,1,6,6,0,0,1,6,4,3,0,1,6,9,0,6,0,3,4,6,9,0,9,6,0,0,4,6,3,0,6,0,3,4,3,3,0,6,4,3,4,3,6,0,0,6,0,6,3,9,0,6,4,5,3,9,0,6,3,3,3};
		Planet planet = Planet();
	for (int s: in){
		int status = planet.upgrade_structure(s);
		if (status != 0)
